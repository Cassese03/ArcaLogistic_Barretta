                ...
                <ul class="list-group" id="ajax" style="max-height:500px;">
                    ...
                    <?php  foreach($fornitori as $f){ ?>
                        <li class="list-group-item">
                            <a <?php if(str_replace(' ','',$documenti) == 'BO' || str_replace(' ','',$documenti) == 'DDT' ) echo 'href="/magazzino/carico03/'.$f->Id_CF.'/'.$documenti.'"'; else echo 'href="/magazzino/carico3/'.$f->Id_CF.'/'.$documenti.'"';?> class="media">
